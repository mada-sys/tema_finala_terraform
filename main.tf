...
resource "azurerm_resource_group" "rg10" { # Changed from rg15 to rg16
  name     = "${local.prefix}-rg10" # Changed from rg15 to rg16
...
resource "azurerm_virtual_network" "vnet" {
  ...
  location            = azurerm_resource_group.rg10.location # Changed from rg15 to rg16
  resource_group_name = azurerm_resource_group.rg10.name     # Changed from rg15 to rg16
}
