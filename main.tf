...
resource "azurerm_resource_group" "rg16" { # Changed from rg15 to rg16
  name     = "${local.prefix}-rg16" # Changed from rg15 to rg16
...
resource "azurerm_virtual_network" "vnet" {
  ...
  location            = azurerm_resource_group.rg16.location # Changed from rg15 to rg16
  resource_group_name = azurerm_resource_group.rg16.name     # Changed from rg15 to rg16
}
