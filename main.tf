...
resource "azurerm_resource_group" "rg15" { # Changed from rg13 to rg15
  name     = "${local.prefix}-rg15" # Changed from rg13 to rg15
...
resource "azurerm_virtual_network" "vnet" {
  ...
  location            = azurerm_resource_group.rg15.location # Changed from rg13 to rg15
  resource_group_name = azurerm_resource_group.rg15.name     # Changed from rg13 to rg15
}
